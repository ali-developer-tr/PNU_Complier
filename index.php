...
include "header.php";
?>
<div class="aslei col-12 col-sm-12 col-md-12 col-xl-12 col-lg-12">
    <div class="row">
        <div class="clearfix">
            <div class="box1 shadow">
                <div class="my-imag mt-2 ml-4 ">
        ...
        <div class="row">
            <div class="container">
                <div class="box2 col-12 col-lg-5 col-sm-12 col-md-12 col-xl-5 mt-3 shadow w-100">
    ...
    <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-3 w-100 shadow">
            <div class="my-news">
                <div class="my-imag">
